        ...
        JSX.createElement("details", { class: "tsd-accordion", open: false },
            ...
            JSX.createElement("div", { class: "tsd-accordion-details" },
                visibilityOptions.length && (JSX.createElement("div", { class: "tsd-filter-visibility" },
                    JSX.createElement("span", { class: "settings-label" }, context.i18n.theme_member_visibility()),
                    JSX.createElement("ul", { id: "tsd-filter-options" }, ...visibilityOptions))),
                JSX.createElement("div", { class: "tsd-theme-toggle" },
                    JSX.createElement("label", { class: "settings-label", for: "tsd-theme" }, context.i18n.theme_theme()),
                    JSX.createElement("select", { id: "tsd-theme" },
                        JSX.createElement("option", { value: "os" }, context.i18n.theme_os()),
                        JSX.createElement("option", { value: "light" }, context.i18n.theme_light()),
                        JSX.createElement("option", { value: "dark" }, context.i18n.theme_dark())))))));
}
export const navigation = function navigation(context, props) {
    return (JSX.createElement("nav", { class: "tsd-navigation" },
        JSX.createElement("a", { href: context.urlTo(props.project), class: classNames({ current: props.url === props.model.url && props.model.isProject() }) }, getDisplayName(props.project)),
