import { YarnTool, PnpmTool, NpmTool, LernaTool, RushTool, RootTool } from '@manypkg/tools';
 ...
 * checked last.
 */
const DEFAULT_TOOLS = [YarnTool, PnpmTool, NpmTool, LernaTool, RushTool, RootTool];
