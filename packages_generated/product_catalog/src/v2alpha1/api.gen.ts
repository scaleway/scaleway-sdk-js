...
import { enrichForPagination, API as ParentAPI, resolveOneOf, urlParams } from '@scaleway/sdk-client'
        ...
        urlParams: urlParams(
          ...
          ...Object.entries(
            resolveOneOf<boolean | ScwRegion | ScwZone | string>([
              ...
              { default: this.client.settings.defaultRegion, param: 'region', value: request.region },
              { default: this.client.settings.defaultZone, param: 'zone', value: request.zone },
