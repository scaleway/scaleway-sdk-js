...
export class API extends ParentAPI {
   ...
   * @returns A Promise of ReadReplica
   */
  waitForReadReplica = (request: Readonly<GetReadReplicaRequest>, options?: Readonly<WaitForOptions<ReadReplica>>) =>
    waitForResource(
...
The configured endpoints do not change.
   ...
   * @returns A Promise of InstanceLog
   */
  waitForInstanceLog = (request: Readonly<GetInstanceLogRequest>, options?: Readonly<WaitForOptions<InstanceLog>>) =>
    waitForResource(
