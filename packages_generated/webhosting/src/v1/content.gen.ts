...
export const DOMAIN_AVAILABILITY_TRANSIENT_STATUSES: DomainAvailabilityStatus[] = ['validating']
...
export const HOSTING_TRANSIENT_STATUSES: HostingStatus[] = ['delivering', 'deleting', 'migrating', 'updating']
