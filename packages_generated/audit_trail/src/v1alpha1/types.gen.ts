...
export type ServerlessContainersTriggerInfoSourceType =
  | 'unknown_source_type'
  | 'cron'
  | 'sqs'
  | 'nats'

export type ServerlessFunctionsTriggerInfoInputType =
  | 'unknown_input_type'
  | 'scw_sqs'
  | 'scw_nats'
...
export interface AuditTrailCustomAlertRuleInfo {
}
...
export interface EdgeServicesVPCEndpointInfo {
...
export interface ObservabilityAlertRuleInfo {
  ruleIds: string[]
}


export interface ObservabilityContactPointInfo {
  email: string
}
...
export interface ServerlessContainersDomainInfo {
  containerId: string
}


export interface ServerlessContainersNamespaceInfo {
}


export interface ServerlessContainersTriggerInfo {
  containerId: string
  sourceType: ServerlessContainersTriggerInfoSourceType
}


export interface ServerlessFunctionsCronInfo {
  functionId: string
}


export interface ServerlessFunctionsDomainInfo {
  functionId: string
}
...
export interface ServerlessFunctionsNamespaceInfo {
}


export interface ServerlessFunctionsTriggerInfo {
  functionId: string
  inputType: ServerlessFunctionsTriggerInfoInputType
}
...
export interface VpcIngressRuleInfo {
  vpcId: string
  source: string
...
export interface WoflWorkflowDefinitionInfo {
  name: string
  description?: string
}


export interface WoflWorkflowRunInfo {
...
export interface WoflWorkflowVersionInfo {
  workflowDefinitionId: string
  workflowDefinitionName?: string
  name: string
}
...
export interface Resource {
   ...
   * One-of ('info'): at most one of 'secmSecretInfo', 'secmSecretVersionInfo', 'kubeClusterInfo', 'kubePoolInfo', 'kubeNodeInfo', 'kubeAclInfo', 'keymKeyInfo', 'secretManagerSecretInfo', 'secretManagerVersionInfo', 'keyManagerKeyInfo', 'accountUserInfo', 'accountOrganizationInfo', 'instanceServerInfo', 'appleSiliconServerInfo', 'accountProjectInfo', 'baremetalServerInfo', 'baremetalSettingInfo', 'ipamIpInfo', 'loadBalancerLbInfo', 'loadBalancerIpInfo', 'loadBalancerFrontendInfo', 'loadBalancerBackendInfo', 'loadBalancerRouteInfo', 'loadBalancerAclInfo', 'loadBalancerCertificateInfo', 'edgeServicesPlanInfo', 'edgeServicesPipelineInfo', 'edgeServicesDnsStageInfo', 'edgeServicesTlsStageInfo', 'edgeServicesCacheStageInfo', 'edgeServicesRouteStageInfo', 'edgeServicesRouteRulesInfo', 'edgeServicesWafStageInfo', 'edgeServicesBackendStageInfo', 'accountContractSignatureInfo', 'vpcSubnetInfo', 'vpcRouteInfo', 'vpcPrivateNetworkInfo', 'auditTrailExportJobInfo', 'vpcGwGatewayInfo', 'vpcGwGatewayNetworkInfo', 'appleSiliconRunnerInfo', 'auditTrailAlertRuleInfo', 'vpcConnectorInfo', 'instancePrivateNetworkInterfaceInfo', 'vpcIngressRuleInfo', 'observabilityContactPointInfo', 'observabilityAlertRuleInfo', 'edgeServicesVpcEndpointInfo', 'auditTrailCustomAlertRuleInfo', 'serverlessContainersNamespaceInfo', 'serverlessContainersContainerInfo', 'serverlessContainersDomainInfo', 'serverlessContainersTriggerInfo', 'serverlessFunctionsNamespaceInfo', 'serverlessFunctionsFunctionInfo', 'serverlessFunctionsDomainInfo', 'serverlessFunctionsCronInfo', 'serverlessFunctionsTriggerInfo', 'woflWorkflowDefinitionInfo', 'woflWorkflowRunInfo', 'woflWorkflowVersionInfo' could be set.
   */
  vpcIngressRuleInfo?: VpcIngressRuleInfo
  /**
   *
   * One-of ('info'): at most one of 'secmSecretInfo', 'secmSecretVersionInfo', 'kubeClusterInfo', 'kubePoolInfo', 'kubeNodeInfo', 'kubeAclInfo', 'keymKeyInfo', 'secretManagerSecretInfo', 'secretManagerVersionInfo', 'keyManagerKeyInfo', 'accountUserInfo', 'accountOrganizationInfo', 'instanceServerInfo', 'appleSiliconServerInfo', 'accountProjectInfo', 'baremetalServerInfo', 'baremetalSettingInfo', 'ipamIpInfo', 'loadBalancerLbInfo', 'loadBalancerIpInfo', 'loadBalancerFrontendInfo', 'loadBalancerBackendInfo', 'loadBalancerRouteInfo', 'loadBalancerAclInfo', 'loadBalancerCertificateInfo', 'edgeServicesPlanInfo', 'edgeServicesPipelineInfo', 'edgeServicesDnsStageInfo', 'edgeServicesTlsStageInfo', 'edgeServicesCacheStageInfo', 'edgeServicesRouteStageInfo', 'edgeServicesRouteRulesInfo', 'edgeServicesWafStageInfo', 'edgeServicesBackendStageInfo', 'accountContractSignatureInfo', 'vpcSubnetInfo', 'vpcRouteInfo', 'vpcPrivateNetworkInfo', 'auditTrailExportJobInfo', 'vpcGwGatewayInfo', 'vpcGwGatewayNetworkInfo', 'appleSiliconRunnerInfo', 'auditTrailAlertRuleInfo', 'vpcConnectorInfo', 'instancePrivateNetworkInterfaceInfo', 'vpcIngressRuleInfo', 'observabilityContactPointInfo', 'observabilityAlertRuleInfo', 'edgeServicesVpcEndpointInfo', 'auditTrailCustomAlertRuleInfo', 'serverlessContainersNamespaceInfo', 'serverlessContainersContainerInfo', 'serverlessContainersDomainInfo', 'serverlessContainersTriggerInfo', 'serverlessFunctionsNamespaceInfo', 'serverlessFunctionsFunctionInfo', 'serverlessFunctionsDomainInfo', 'serverlessFunctionsCronInfo', 'serverlessFunctionsTriggerInfo', 'woflWorkflowDefinitionInfo', 'woflWorkflowRunInfo', 'woflWorkflowVersionInfo' could be set.
   */
  observabilityContactPointInfo?: ObservabilityContactPointInfo
  /**
   *
   * One-of ('info'): at most one of 'secmSecretInfo', 'secmSecretVersionInfo', 'kubeClusterInfo', 'kubePoolInfo', 'kubeNodeInfo', 'kubeAclInfo', 'keymKeyInfo', 'secretManagerSecretInfo', 'secretManagerVersionInfo', 'keyManagerKeyInfo', 'accountUserInfo', 'accountOrganizationInfo', 'instanceServerInfo', 'appleSiliconServerInfo', 'accountProjectInfo', 'baremetalServerInfo', 'baremetalSettingInfo', 'ipamIpInfo', 'loadBalancerLbInfo', 'loadBalancerIpInfo', 'loadBalancerFrontendInfo', 'loadBalancerBackendInfo', 'loadBalancerRouteInfo', 'loadBalancerAclInfo', 'loadBalancerCertificateInfo', 'edgeServicesPlanInfo', 'edgeServicesPipelineInfo', 'edgeServicesDnsStageInfo', 'edgeServicesTlsStageInfo', 'edgeServicesCacheStageInfo', 'edgeServicesRouteStageInfo', 'edgeServicesRouteRulesInfo', 'edgeServicesWafStageInfo', 'edgeServicesBackendStageInfo', 'accountContractSignatureInfo', 'vpcSubnetInfo', 'vpcRouteInfo', 'vpcPrivateNetworkInfo', 'auditTrailExportJobInfo', 'vpcGwGatewayInfo', 'vpcGwGatewayNetworkInfo', 'appleSiliconRunnerInfo', 'auditTrailAlertRuleInfo', 'vpcConnectorInfo', 'instancePrivateNetworkInterfaceInfo', 'vpcIngressRuleInfo', 'observabilityContactPointInfo', 'observabilityAlertRuleInfo', 'edgeServicesVpcEndpointInfo', 'auditTrailCustomAlertRuleInfo', 'serverlessContainersNamespaceInfo', 'serverlessContainersContainerInfo', 'serverlessContainersDomainInfo', 'serverlessContainersTriggerInfo', 'serverlessFunctionsNamespaceInfo', 'serverlessFunctionsFunctionInfo', 'serverlessFunctionsDomainInfo', 'serverlessFunctionsCronInfo', 'serverlessFunctionsTriggerInfo', 'woflWorkflowDefinitionInfo', 'woflWorkflowRunInfo', 'woflWorkflowVersionInfo' could be set.
   */
  observabilityAlertRuleInfo?: ObservabilityAlertRuleInfo
  /**
   *
   * One-of ('info'): at most one of 'secmSecretInfo', 'secmSecretVersionInfo', 'kubeClusterInfo', 'kubePoolInfo', 'kubeNodeInfo', 'kubeAclInfo', 'keymKeyInfo', 'secretManagerSecretInfo', 'secretManagerVersionInfo', 'keyManagerKeyInfo', 'accountUserInfo', 'accountOrganizationInfo', 'instanceServerInfo', 'appleSiliconServerInfo', 'accountProjectInfo', 'baremetalServerInfo', 'baremetalSettingInfo', 'ipamIpInfo', 'loadBalancerLbInfo', 'loadBalancerIpInfo', 'loadBalancerFrontendInfo', 'loadBalancerBackendInfo', 'loadBalancerRouteInfo', 'loadBalancerAclInfo', 'loadBalancerCertificateInfo', 'edgeServicesPlanInfo', 'edgeServicesPipelineInfo', 'edgeServicesDnsStageInfo', 'edgeServicesTlsStageInfo', 'edgeServicesCacheStageInfo', 'edgeServicesRouteStageInfo', 'edgeServicesRouteRulesInfo', 'edgeServicesWafStageInfo', 'edgeServicesBackendStageInfo', 'accountContractSignatureInfo', 'vpcSubnetInfo', 'vpcRouteInfo', 'vpcPrivateNetworkInfo', 'auditTrailExportJobInfo', 'vpcGwGatewayInfo', 'vpcGwGatewayNetworkInfo', 'appleSiliconRunnerInfo', 'auditTrailAlertRuleInfo', 'vpcConnectorInfo', 'instancePrivateNetworkInterfaceInfo', 'vpcIngressRuleInfo', 'observabilityContactPointInfo', 'observabilityAlertRuleInfo', 'edgeServicesVpcEndpointInfo', 'auditTrailCustomAlertRuleInfo', 'serverlessContainersNamespaceInfo', 'serverlessContainersContainerInfo', 'serverlessContainersDomainInfo', 'serverlessContainersTriggerInfo', 'serverlessFunctionsNamespaceInfo', 'serverlessFunctionsFunctionInfo', 'serverlessFunctionsDomainInfo', 'serverlessFunctionsCronInfo', 'serverlessFunctionsTriggerInfo', 'woflWorkflowDefinitionInfo', 'woflWorkflowRunInfo', 'woflWorkflowVersionInfo' could be set.
   */
  edgeServicesVpcEndpointInfo?: EdgeServicesVPCEndpointInfo
  /**
   *
   * One-of ('info'): at most one of 'secmSecretInfo', 'secmSecretVersionInfo', 'kubeClusterInfo', 'kubePoolInfo', 'kubeNodeInfo', 'kubeAclInfo', 'keymKeyInfo', 'secretManagerSecretInfo', 'secretManagerVersionInfo', 'keyManagerKeyInfo', 'accountUserInfo', 'accountOrganizationInfo', 'instanceServerInfo', 'appleSiliconServerInfo', 'accountProjectInfo', 'baremetalServerInfo', 'baremetalSettingInfo', 'ipamIpInfo', 'loadBalancerLbInfo', 'loadBalancerIpInfo', 'loadBalancerFrontendInfo', 'loadBalancerBackendInfo', 'loadBalancerRouteInfo', 'loadBalancerAclInfo', 'loadBalancerCertificateInfo', 'edgeServicesPlanInfo', 'edgeServicesPipelineInfo', 'edgeServicesDnsStageInfo', 'edgeServicesTlsStageInfo', 'edgeServicesCacheStageInfo', 'edgeServicesRouteStageInfo', 'edgeServicesRouteRulesInfo', 'edgeServicesWafStageInfo', 'edgeServicesBackendStageInfo', 'accountContractSignatureInfo', 'vpcSubnetInfo', 'vpcRouteInfo', 'vpcPrivateNetworkInfo', 'auditTrailExportJobInfo', 'vpcGwGatewayInfo', 'vpcGwGatewayNetworkInfo', 'appleSiliconRunnerInfo', 'auditTrailAlertRuleInfo', 'vpcConnectorInfo', 'instancePrivateNetworkInterfaceInfo', 'vpcIngressRuleInfo', 'observabilityContactPointInfo', 'observabilityAlertRuleInfo', 'edgeServicesVpcEndpointInfo', 'auditTrailCustomAlertRuleInfo', 'serverlessContainersNamespaceInfo', 'serverlessContainersContainerInfo', 'serverlessContainersDomainInfo', 'serverlessContainersTriggerInfo', 'serverlessFunctionsNamespaceInfo', 'serverlessFunctionsFunctionInfo', 'serverlessFunctionsDomainInfo', 'serverlessFunctionsCronInfo', 'serverlessFunctionsTriggerInfo', 'woflWorkflowDefinitionInfo', 'woflWorkflowRunInfo', 'woflWorkflowVersionInfo' could be set.
   */
  auditTrailCustomAlertRuleInfo?: AuditTrailCustomAlertRuleInfo
  /**
   *
   * One-of ('info'): at most one of 'secmSecretInfo', 'secmSecretVersionInfo', 'kubeClusterInfo', 'kubePoolInfo', 'kubeNodeInfo', 'kubeAclInfo', 'keymKeyInfo', 'secretManagerSecretInfo', 'secretManagerVersionInfo', 'keyManagerKeyInfo', 'accountUserInfo', 'accountOrganizationInfo', 'instanceServerInfo', 'appleSiliconServerInfo', 'accountProjectInfo', 'baremetalServerInfo', 'baremetalSettingInfo', 'ipamIpInfo', 'loadBalancerLbInfo', 'loadBalancerIpInfo', 'loadBalancerFrontendInfo', 'loadBalancerBackendInfo', 'loadBalancerRouteInfo', 'loadBalancerAclInfo', 'loadBalancerCertificateInfo', 'edgeServicesPlanInfo', 'edgeServicesPipelineInfo', 'edgeServicesDnsStageInfo', 'edgeServicesTlsStageInfo', 'edgeServicesCacheStageInfo', 'edgeServicesRouteStageInfo', 'edgeServicesRouteRulesInfo', 'edgeServicesWafStageInfo', 'edgeServicesBackendStageInfo', 'accountContractSignatureInfo', 'vpcSubnetInfo', 'vpcRouteInfo', 'vpcPrivateNetworkInfo', 'auditTrailExportJobInfo', 'vpcGwGatewayInfo', 'vpcGwGatewayNetworkInfo', 'appleSiliconRunnerInfo', 'auditTrailAlertRuleInfo', 'vpcConnectorInfo', 'instancePrivateNetworkInterfaceInfo', 'vpcIngressRuleInfo', 'observabilityContactPointInfo', 'observabilityAlertRuleInfo', 'edgeServicesVpcEndpointInfo', 'auditTrailCustomAlertRuleInfo', 'serverlessContainersNamespaceInfo', 'serverlessContainersContainerInfo', 'serverlessContainersDomainInfo', 'serverlessContainersTriggerInfo', 'serverlessFunctionsNamespaceInfo', 'serverlessFunctionsFunctionInfo', 'serverlessFunctionsDomainInfo', 'serverlessFunctionsCronInfo', 'serverlessFunctionsTriggerInfo', 'woflWorkflowDefinitionInfo', 'woflWorkflowRunInfo', 'woflWorkflowVersionInfo' could be set.
   */
  serverlessContainersNamespaceInfo?: ServerlessContainersNamespaceInfo
  /**
   *
   * One-of ('info'): at most one of 'secmSecretInfo', 'secmSecretVersionInfo', 'kubeClusterInfo', 'kubePoolInfo', 'kubeNodeInfo', 'kubeAclInfo', 'keymKeyInfo', 'secretManagerSecretInfo', 'secretManagerVersionInfo', 'keyManagerKeyInfo', 'accountUserInfo', 'accountOrganizationInfo', 'instanceServerInfo', 'appleSiliconServerInfo', 'accountProjectInfo', 'baremetalServerInfo', 'baremetalSettingInfo', 'ipamIpInfo', 'loadBalancerLbInfo', 'loadBalancerIpInfo', 'loadBalancerFrontendInfo', 'loadBalancerBackendInfo', 'loadBalancerRouteInfo', 'loadBalancerAclInfo', 'loadBalancerCertificateInfo', 'edgeServicesPlanInfo', 'edgeServicesPipelineInfo', 'edgeServicesDnsStageInfo', 'edgeServicesTlsStageInfo', 'edgeServicesCacheStageInfo', 'edgeServicesRouteStageInfo', 'edgeServicesRouteRulesInfo', 'edgeServicesWafStageInfo', 'edgeServicesBackendStageInfo', 'accountContractSignatureInfo', 'vpcSubnetInfo', 'vpcRouteInfo', 'vpcPrivateNetworkInfo', 'auditTrailExportJobInfo', 'vpcGwGatewayInfo', 'vpcGwGatewayNetworkInfo', 'appleSiliconRunnerInfo', 'auditTrailAlertRuleInfo', 'vpcConnectorInfo', 'instancePrivateNetworkInterfaceInfo', 'vpcIngressRuleInfo', 'observabilityContactPointInfo', 'observabilityAlertRuleInfo', 'edgeServicesVpcEndpointInfo', 'auditTrailCustomAlertRuleInfo', 'serverlessContainersNamespaceInfo', 'serverlessContainersContainerInfo', 'serverlessContainersDomainInfo', 'serverlessContainersTriggerInfo', 'serverlessFunctionsNamespaceInfo', 'serverlessFunctionsFunctionInfo', 'serverlessFunctionsDomainInfo', 'serverlessFunctionsCronInfo', 'serverlessFunctionsTriggerInfo', 'woflWorkflowDefinitionInfo', 'woflWorkflowRunInfo', 'woflWorkflowVersionInfo' could be set.
   */
   ...
   * One-of ('info'): at most one of 'secmSecretInfo', 'secmSecretVersionInfo', 'kubeClusterInfo', 'kubePoolInfo', 'kubeNodeInfo', 'kubeAclInfo', 'keymKeyInfo', 'secretManagerSecretInfo', 'secretManagerVersionInfo', 'keyManagerKeyInfo', 'accountUserInfo', 'accountOrganizationInfo', 'instanceServerInfo', 'appleSiliconServerInfo', 'accountProjectInfo', 'baremetalServerInfo', 'baremetalSettingInfo', 'ipamIpInfo', 'loadBalancerLbInfo', 'loadBalancerIpInfo', 'loadBalancerFrontendInfo', 'loadBalancerBackendInfo', 'loadBalancerRouteInfo', 'loadBalancerAclInfo', 'loadBalancerCertificateInfo', 'edgeServicesPlanInfo', 'edgeServicesPipelineInfo', 'edgeServicesDnsStageInfo', 'edgeServicesTlsStageInfo', 'edgeServicesCacheStageInfo', 'edgeServicesRouteStageInfo', 'edgeServicesRouteRulesInfo', 'edgeServicesWafStageInfo', 'edgeServicesBackendStageInfo', 'accountContractSignatureInfo', 'vpcSubnetInfo', 'vpcRouteInfo', 'vpcPrivateNetworkInfo', 'auditTrailExportJobInfo', 'vpcGwGatewayInfo', 'vpcGwGatewayNetworkInfo', 'appleSiliconRunnerInfo', 'auditTrailAlertRuleInfo', 'vpcConnectorInfo', 'instancePrivateNetworkInterfaceInfo', 'vpcIngressRuleInfo', 'observabilityContactPointInfo', 'observabilityAlertRuleInfo', 'edgeServicesVpcEndpointInfo', 'auditTrailCustomAlertRuleInfo', 'serverlessContainersNamespaceInfo', 'serverlessContainersContainerInfo', 'serverlessContainersDomainInfo', 'serverlessContainersTriggerInfo', 'serverlessFunctionsNamespaceInfo', 'serverlessFunctionsFunctionInfo', 'serverlessFunctionsDomainInfo', 'serverlessFunctionsCronInfo', 'serverlessFunctionsTriggerInfo', 'woflWorkflowDefinitionInfo', 'woflWorkflowRunInfo', 'woflWorkflowVersionInfo' could be set.
   */
  serverlessContainersDomainInfo?: ServerlessContainersDomainInfo
  /**
   *
   * One-of ('info'): at most one of 'secmSecretInfo', 'secmSecretVersionInfo', 'kubeClusterInfo', 'kubePoolInfo', 'kubeNodeInfo', 'kubeAclInfo', 'keymKeyInfo', 'secretManagerSecretInfo', 'secretManagerVersionInfo', 'keyManagerKeyInfo', 'accountUserInfo', 'accountOrganizationInfo', 'instanceServerInfo', 'appleSiliconServerInfo', 'accountProjectInfo', 'baremetalServerInfo', 'baremetalSettingInfo', 'ipamIpInfo', 'loadBalancerLbInfo', 'loadBalancerIpInfo', 'loadBalancerFrontendInfo', 'loadBalancerBackendInfo', 'loadBalancerRouteInfo', 'loadBalancerAclInfo', 'loadBalancerCertificateInfo', 'edgeServicesPlanInfo', 'edgeServicesPipelineInfo', 'edgeServicesDnsStageInfo', 'edgeServicesTlsStageInfo', 'edgeServicesCacheStageInfo', 'edgeServicesRouteStageInfo', 'edgeServicesRouteRulesInfo', 'edgeServicesWafStageInfo', 'edgeServicesBackendStageInfo', 'accountContractSignatureInfo', 'vpcSubnetInfo', 'vpcRouteInfo', 'vpcPrivateNetworkInfo', 'auditTrailExportJobInfo', 'vpcGwGatewayInfo', 'vpcGwGatewayNetworkInfo', 'appleSiliconRunnerInfo', 'auditTrailAlertRuleInfo', 'vpcConnectorInfo', 'instancePrivateNetworkInterfaceInfo', 'vpcIngressRuleInfo', 'observabilityContactPointInfo', 'observabilityAlertRuleInfo', 'edgeServicesVpcEndpointInfo', 'auditTrailCustomAlertRuleInfo', 'serverlessContainersNamespaceInfo', 'serverlessContainersContainerInfo', 'serverlessContainersDomainInfo', 'serverlessContainersTriggerInfo', 'serverlessFunctionsNamespaceInfo', 'serverlessFunctionsFunctionInfo', 'serverlessFunctionsDomainInfo', 'serverlessFunctionsCronInfo', 'serverlessFunctionsTriggerInfo', 'woflWorkflowDefinitionInfo', 'woflWorkflowRunInfo', 'woflWorkflowVersionInfo' could be set.
   */
  serverlessContainersTriggerInfo?: ServerlessContainersTriggerInfo
  /**
   *
   * One-of ('info'): at most one of 'secmSecretInfo', 'secmSecretVersionInfo', 'kubeClusterInfo', 'kubePoolInfo', 'kubeNodeInfo', 'kubeAclInfo', 'keymKeyInfo', 'secretManagerSecretInfo', 'secretManagerVersionInfo', 'keyManagerKeyInfo', 'accountUserInfo', 'accountOrganizationInfo', 'instanceServerInfo', 'appleSiliconServerInfo', 'accountProjectInfo', 'baremetalServerInfo', 'baremetalSettingInfo', 'ipamIpInfo', 'loadBalancerLbInfo', 'loadBalancerIpInfo', 'loadBalancerFrontendInfo', 'loadBalancerBackendInfo', 'loadBalancerRouteInfo', 'loadBalancerAclInfo', 'loadBalancerCertificateInfo', 'edgeServicesPlanInfo', 'edgeServicesPipelineInfo', 'edgeServicesDnsStageInfo', 'edgeServicesTlsStageInfo', 'edgeServicesCacheStageInfo', 'edgeServicesRouteStageInfo', 'edgeServicesRouteRulesInfo', 'edgeServicesWafStageInfo', 'edgeServicesBackendStageInfo', 'accountContractSignatureInfo', 'vpcSubnetInfo', 'vpcRouteInfo', 'vpcPrivateNetworkInfo', 'auditTrailExportJobInfo', 'vpcGwGatewayInfo', 'vpcGwGatewayNetworkInfo', 'appleSiliconRunnerInfo', 'auditTrailAlertRuleInfo', 'vpcConnectorInfo', 'instancePrivateNetworkInterfaceInfo', 'vpcIngressRuleInfo', 'observabilityContactPointInfo', 'observabilityAlertRuleInfo', 'edgeServicesVpcEndpointInfo', 'auditTrailCustomAlertRuleInfo', 'serverlessContainersNamespaceInfo', 'serverlessContainersContainerInfo', 'serverlessContainersDomainInfo', 'serverlessContainersTriggerInfo', 'serverlessFunctionsNamespaceInfo', 'serverlessFunctionsFunctionInfo', 'serverlessFunctionsDomainInfo', 'serverlessFunctionsCronInfo', 'serverlessFunctionsTriggerInfo', 'woflWorkflowDefinitionInfo', 'woflWorkflowRunInfo', 'woflWorkflowVersionInfo' could be set.
   */
  serverlessFunctionsNamespaceInfo?: ServerlessFunctionsNamespaceInfo
  /**
   *
   * One-of ('info'): at most one of 'secmSecretInfo', 'secmSecretVersionInfo', 'kubeClusterInfo', 'kubePoolInfo', 'kubeNodeInfo', 'kubeAclInfo', 'keymKeyInfo', 'secretManagerSecretInfo', 'secretManagerVersionInfo', 'keyManagerKeyInfo', 'accountUserInfo', 'accountOrganizationInfo', 'instanceServerInfo', 'appleSiliconServerInfo', 'accountProjectInfo', 'baremetalServerInfo', 'baremetalSettingInfo', 'ipamIpInfo', 'loadBalancerLbInfo', 'loadBalancerIpInfo', 'loadBalancerFrontendInfo', 'loadBalancerBackendInfo', 'loadBalancerRouteInfo', 'loadBalancerAclInfo', 'loadBalancerCertificateInfo', 'edgeServicesPlanInfo', 'edgeServicesPipelineInfo', 'edgeServicesDnsStageInfo', 'edgeServicesTlsStageInfo', 'edgeServicesCacheStageInfo', 'edgeServicesRouteStageInfo', 'edgeServicesRouteRulesInfo', 'edgeServicesWafStageInfo', 'edgeServicesBackendStageInfo', 'accountContractSignatureInfo', 'vpcSubnetInfo', 'vpcRouteInfo', 'vpcPrivateNetworkInfo', 'auditTrailExportJobInfo', 'vpcGwGatewayInfo', 'vpcGwGatewayNetworkInfo', 'appleSiliconRunnerInfo', 'auditTrailAlertRuleInfo', 'vpcConnectorInfo', 'instancePrivateNetworkInterfaceInfo', 'vpcIngressRuleInfo', 'observabilityContactPointInfo', 'observabilityAlertRuleInfo', 'edgeServicesVpcEndpointInfo', 'auditTrailCustomAlertRuleInfo', 'serverlessContainersNamespaceInfo', 'serverlessContainersContainerInfo', 'serverlessContainersDomainInfo', 'serverlessContainersTriggerInfo', 'serverlessFunctionsNamespaceInfo', 'serverlessFunctionsFunctionInfo', 'serverlessFunctionsDomainInfo', 'serverlessFunctionsCronInfo', 'serverlessFunctionsTriggerInfo', 'woflWorkflowDefinitionInfo', 'woflWorkflowRunInfo', 'woflWorkflowVersionInfo' could be set.
   */
   ...
   * One-of ('info'): at most one of 'secmSecretInfo', 'secmSecretVersionInfo', 'kubeClusterInfo', 'kubePoolInfo', 'kubeNodeInfo', 'kubeAclInfo', 'keymKeyInfo', 'secretManagerSecretInfo', 'secretManagerVersionInfo', 'keyManagerKeyInfo', 'accountUserInfo', 'accountOrganizationInfo', 'instanceServerInfo', 'appleSiliconServerInfo', 'accountProjectInfo', 'baremetalServerInfo', 'baremetalSettingInfo', 'ipamIpInfo', 'loadBalancerLbInfo', 'loadBalancerIpInfo', 'loadBalancerFrontendInfo', 'loadBalancerBackendInfo', 'loadBalancerRouteInfo', 'loadBalancerAclInfo', 'loadBalancerCertificateInfo', 'edgeServicesPlanInfo', 'edgeServicesPipelineInfo', 'edgeServicesDnsStageInfo', 'edgeServicesTlsStageInfo', 'edgeServicesCacheStageInfo', 'edgeServicesRouteStageInfo', 'edgeServicesRouteRulesInfo', 'edgeServicesWafStageInfo', 'edgeServicesBackendStageInfo', 'accountContractSignatureInfo', 'vpcSubnetInfo', 'vpcRouteInfo', 'vpcPrivateNetworkInfo', 'auditTrailExportJobInfo', 'vpcGwGatewayInfo', 'vpcGwGatewayNetworkInfo', 'appleSiliconRunnerInfo', 'auditTrailAlertRuleInfo', 'vpcConnectorInfo', 'instancePrivateNetworkInterfaceInfo', 'vpcIngressRuleInfo', 'observabilityContactPointInfo', 'observabilityAlertRuleInfo', 'edgeServicesVpcEndpointInfo', 'auditTrailCustomAlertRuleInfo', 'serverlessContainersNamespaceInfo', 'serverlessContainersContainerInfo', 'serverlessContainersDomainInfo', 'serverlessContainersTriggerInfo', 'serverlessFunctionsNamespaceInfo', 'serverlessFunctionsFunctionInfo', 'serverlessFunctionsDomainInfo', 'serverlessFunctionsCronInfo', 'serverlessFunctionsTriggerInfo', 'woflWorkflowDefinitionInfo', 'woflWorkflowRunInfo', 'woflWorkflowVersionInfo' could be set.
   */
  serverlessFunctionsDomainInfo?: ServerlessFunctionsDomainInfo
  /**
   *
   * One-of ('info'): at most one of 'secmSecretInfo', 'secmSecretVersionInfo', 'kubeClusterInfo', 'kubePoolInfo', 'kubeNodeInfo', 'kubeAclInfo', 'keymKeyInfo', 'secretManagerSecretInfo', 'secretManagerVersionInfo', 'keyManagerKeyInfo', 'accountUserInfo', 'accountOrganizationInfo', 'instanceServerInfo', 'appleSiliconServerInfo', 'accountProjectInfo', 'baremetalServerInfo', 'baremetalSettingInfo', 'ipamIpInfo', 'loadBalancerLbInfo', 'loadBalancerIpInfo', 'loadBalancerFrontendInfo', 'loadBalancerBackendInfo', 'loadBalancerRouteInfo', 'loadBalancerAclInfo', 'loadBalancerCertificateInfo', 'edgeServicesPlanInfo', 'edgeServicesPipelineInfo', 'edgeServicesDnsStageInfo', 'edgeServicesTlsStageInfo', 'edgeServicesCacheStageInfo', 'edgeServicesRouteStageInfo', 'edgeServicesRouteRulesInfo', 'edgeServicesWafStageInfo', 'edgeServicesBackendStageInfo', 'accountContractSignatureInfo', 'vpcSubnetInfo', 'vpcRouteInfo', 'vpcPrivateNetworkInfo', 'auditTrailExportJobInfo', 'vpcGwGatewayInfo', 'vpcGwGatewayNetworkInfo', 'appleSiliconRunnerInfo', 'auditTrailAlertRuleInfo', 'vpcConnectorInfo', 'instancePrivateNetworkInterfaceInfo', 'vpcIngressRuleInfo', 'observabilityContactPointInfo', 'observabilityAlertRuleInfo', 'edgeServicesVpcEndpointInfo', 'auditTrailCustomAlertRuleInfo', 'serverlessContainersNamespaceInfo', 'serverlessContainersContainerInfo', 'serverlessContainersDomainInfo', 'serverlessContainersTriggerInfo', 'serverlessFunctionsNamespaceInfo', 'serverlessFunctionsFunctionInfo', 'serverlessFunctionsDomainInfo', 'serverlessFunctionsCronInfo', 'serverlessFunctionsTriggerInfo', 'woflWorkflowDefinitionInfo', 'woflWorkflowRunInfo', 'woflWorkflowVersionInfo' could be set.
   */
  serverlessFunctionsCronInfo?: ServerlessFunctionsCronInfo
  /**
   *
   * One-of ('info'): at most one of 'secmSecretInfo', 'secmSecretVersionInfo', 'kubeClusterInfo', 'kubePoolInfo', 'kubeNodeInfo', 'kubeAclInfo', 'keymKeyInfo', 'secretManagerSecretInfo', 'secretManagerVersionInfo', 'keyManagerKeyInfo', 'accountUserInfo', 'accountOrganizationInfo', 'instanceServerInfo', 'appleSiliconServerInfo', 'accountProjectInfo', 'baremetalServerInfo', 'baremetalSettingInfo', 'ipamIpInfo', 'loadBalancerLbInfo', 'loadBalancerIpInfo', 'loadBalancerFrontendInfo', 'loadBalancerBackendInfo', 'loadBalancerRouteInfo', 'loadBalancerAclInfo', 'loadBalancerCertificateInfo', 'edgeServicesPlanInfo', 'edgeServicesPipelineInfo', 'edgeServicesDnsStageInfo', 'edgeServicesTlsStageInfo', 'edgeServicesCacheStageInfo', 'edgeServicesRouteStageInfo', 'edgeServicesRouteRulesInfo', 'edgeServicesWafStageInfo', 'edgeServicesBackendStageInfo', 'accountContractSignatureInfo', 'vpcSubnetInfo', 'vpcRouteInfo', 'vpcPrivateNetworkInfo', 'auditTrailExportJobInfo', 'vpcGwGatewayInfo', 'vpcGwGatewayNetworkInfo', 'appleSiliconRunnerInfo', 'auditTrailAlertRuleInfo', 'vpcConnectorInfo', 'instancePrivateNetworkInterfaceInfo', 'vpcIngressRuleInfo', 'observabilityContactPointInfo', 'observabilityAlertRuleInfo', 'edgeServicesVpcEndpointInfo', 'auditTrailCustomAlertRuleInfo', 'serverlessContainersNamespaceInfo', 'serverlessContainersContainerInfo', 'serverlessContainersDomainInfo', 'serverlessContainersTriggerInfo', 'serverlessFunctionsNamespaceInfo', 'serverlessFunctionsFunctionInfo', 'serverlessFunctionsDomainInfo', 'serverlessFunctionsCronInfo', 'serverlessFunctionsTriggerInfo', 'woflWorkflowDefinitionInfo', 'woflWorkflowRunInfo', 'woflWorkflowVersionInfo' could be set.
   */
  serverlessFunctionsTriggerInfo?: ServerlessFunctionsTriggerInfo
  /**
   *
   * One-of ('info'): at most one of 'secmSecretInfo', 'secmSecretVersionInfo', 'kubeClusterInfo', 'kubePoolInfo', 'kubeNodeInfo', 'kubeAclInfo', 'keymKeyInfo', 'secretManagerSecretInfo', 'secretManagerVersionInfo', 'keyManagerKeyInfo', 'accountUserInfo', 'accountOrganizationInfo', 'instanceServerInfo', 'appleSiliconServerInfo', 'accountProjectInfo', 'baremetalServerInfo', 'baremetalSettingInfo', 'ipamIpInfo', 'loadBalancerLbInfo', 'loadBalancerIpInfo', 'loadBalancerFrontendInfo', 'loadBalancerBackendInfo', 'loadBalancerRouteInfo', 'loadBalancerAclInfo', 'loadBalancerCertificateInfo', 'edgeServicesPlanInfo', 'edgeServicesPipelineInfo', 'edgeServicesDnsStageInfo', 'edgeServicesTlsStageInfo', 'edgeServicesCacheStageInfo', 'edgeServicesRouteStageInfo', 'edgeServicesRouteRulesInfo', 'edgeServicesWafStageInfo', 'edgeServicesBackendStageInfo', 'accountContractSignatureInfo', 'vpcSubnetInfo', 'vpcRouteInfo', 'vpcPrivateNetworkInfo', 'auditTrailExportJobInfo', 'vpcGwGatewayInfo', 'vpcGwGatewayNetworkInfo', 'appleSiliconRunnerInfo', 'auditTrailAlertRuleInfo', 'vpcConnectorInfo', 'instancePrivateNetworkInterfaceInfo', 'vpcIngressRuleInfo', 'observabilityContactPointInfo', 'observabilityAlertRuleInfo', 'edgeServicesVpcEndpointInfo', 'auditTrailCustomAlertRuleInfo', 'serverlessContainersNamespaceInfo', 'serverlessContainersContainerInfo', 'serverlessContainersDomainInfo', 'serverlessContainersTriggerInfo', 'serverlessFunctionsNamespaceInfo', 'serverlessFunctionsFunctionInfo', 'serverlessFunctionsDomainInfo', 'serverlessFunctionsCronInfo', 'serverlessFunctionsTriggerInfo', 'woflWorkflowDefinitionInfo', 'woflWorkflowRunInfo', 'woflWorkflowVersionInfo' could be set.
   */
  woflWorkflowDefinitionInfo?: WoflWorkflowDefinitionInfo
  /**
   *
   * One-of ('info'): at most one of 'secmSecretInfo', 'secmSecretVersionInfo', 'kubeClusterInfo', 'kubePoolInfo', 'kubeNodeInfo', 'kubeAclInfo', 'keymKeyInfo', 'secretManagerSecretInfo', 'secretManagerVersionInfo', 'keyManagerKeyInfo', 'accountUserInfo', 'accountOrganizationInfo', 'instanceServerInfo', 'appleSiliconServerInfo', 'accountProjectInfo', 'baremetalServerInfo', 'baremetalSettingInfo', 'ipamIpInfo', 'loadBalancerLbInfo', 'loadBalancerIpInfo', 'loadBalancerFrontendInfo', 'loadBalancerBackendInfo', 'loadBalancerRouteInfo', 'loadBalancerAclInfo', 'loadBalancerCertificateInfo', 'edgeServicesPlanInfo', 'edgeServicesPipelineInfo', 'edgeServicesDnsStageInfo', 'edgeServicesTlsStageInfo', 'edgeServicesCacheStageInfo', 'edgeServicesRouteStageInfo', 'edgeServicesRouteRulesInfo', 'edgeServicesWafStageInfo', 'edgeServicesBackendStageInfo', 'accountContractSignatureInfo', 'vpcSubnetInfo', 'vpcRouteInfo', 'vpcPrivateNetworkInfo', 'auditTrailExportJobInfo', 'vpcGwGatewayInfo', 'vpcGwGatewayNetworkInfo', 'appleSiliconRunnerInfo', 'auditTrailAlertRuleInfo', 'vpcConnectorInfo', 'instancePrivateNetworkInterfaceInfo', 'vpcIngressRuleInfo', 'observabilityContactPointInfo', 'observabilityAlertRuleInfo', 'edgeServicesVpcEndpointInfo', 'auditTrailCustomAlertRuleInfo', 'serverlessContainersNamespaceInfo', 'serverlessContainersContainerInfo', 'serverlessContainersDomainInfo', 'serverlessContainersTriggerInfo', 'serverlessFunctionsNamespaceInfo', 'serverlessFunctionsFunctionInfo', 'serverlessFunctionsDomainInfo', 'serverlessFunctionsCronInfo', 'serverlessFunctionsTriggerInfo', 'woflWorkflowDefinitionInfo', 'woflWorkflowRunInfo', 'woflWorkflowVersionInfo' could be set.
   */
  woflWorkflowRunInfo?: WoflWorkflowRunInfo
  /**
   *
   * One-of ('info'): at most one of 'secmSecretInfo', 'secmSecretVersionInfo', 'kubeClusterInfo', 'kubePoolInfo', 'kubeNodeInfo', 'kubeAclInfo', 'keymKeyInfo', 'secretManagerSecretInfo', 'secretManagerVersionInfo', 'keyManagerKeyInfo', 'accountUserInfo', 'accountOrganizationInfo', 'instanceServerInfo', 'appleSiliconServerInfo', 'accountProjectInfo', 'baremetalServerInfo', 'baremetalSettingInfo', 'ipamIpInfo', 'loadBalancerLbInfo', 'loadBalancerIpInfo', 'loadBalancerFrontendInfo', 'loadBalancerBackendInfo', 'loadBalancerRouteInfo', 'loadBalancerAclInfo', 'loadBalancerCertificateInfo', 'edgeServicesPlanInfo', 'edgeServicesPipelineInfo', 'edgeServicesDnsStageInfo', 'edgeServicesTlsStageInfo', 'edgeServicesCacheStageInfo', 'edgeServicesRouteStageInfo', 'edgeServicesRouteRulesInfo', 'edgeServicesWafStageInfo', 'edgeServicesBackendStageInfo', 'accountContractSignatureInfo', 'vpcSubnetInfo', 'vpcRouteInfo', 'vpcPrivateNetworkInfo', 'auditTrailExportJobInfo', 'vpcGwGatewayInfo', 'vpcGwGatewayNetworkInfo', 'appleSiliconRunnerInfo', 'auditTrailAlertRuleInfo', 'vpcConnectorInfo', 'instancePrivateNetworkInterfaceInfo', 'vpcIngressRuleInfo', 'observabilityContactPointInfo', 'observabilityAlertRuleInfo', 'edgeServicesVpcEndpointInfo', 'auditTrailCustomAlertRuleInfo', 'serverlessContainersNamespaceInfo', 'serverlessContainersContainerInfo', 'serverlessContainersDomainInfo', 'serverlessContainersTriggerInfo', 'serverlessFunctionsNamespaceInfo', 'serverlessFunctionsFunctionInfo', 'serverlessFunctionsDomainInfo', 'serverlessFunctionsCronInfo', 'serverlessFunctionsTriggerInfo', 'woflWorkflowDefinitionInfo', 'woflWorkflowRunInfo', 'woflWorkflowVersionInfo' could be set.
   */
  woflWorkflowVersionInfo?: WoflWorkflowVersionInfo
}
