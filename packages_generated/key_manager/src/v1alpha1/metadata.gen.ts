      ...
      methods: [
        {
          ...
          returnType: 'Key',
          returnTypeNamespace: '@scaleway/sdk-key-manager/v1alpha1',
          isList: false,
          paginationType: 'none',
          isPrivate: false,
          description: '"',
        ...
        },
        {
          ...
          pageParamKey: 'page',
          listItemType: 'Key',
          listItemTypeNamespace: '@scaleway/sdk-key-manager/v1alpha1',
          isPrivate: false,
          description: '"',
        },
        {
          methodName: 'listKeyRotations',
          protoName: 'ListKeyRotations',
          paramsType: 'ListKeyRotationsRequest',
          returnType: 'ListKeyRotationsResponse',
          returnTypeNamespace: '@scaleway/sdk-key-manager/v1alpha1',
          isList: true,
          paginationType: 'offset',
          pageParamKey: 'page',
          listItemType: 'KeyRotation',
          listItemTypeNamespace: '@scaleway/sdk-key-manager/v1alpha1',
          isPrivate: false,
          description: '"',
        },
