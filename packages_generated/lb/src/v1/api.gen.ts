...
export class ZonedAPI extends ParentAPI {
   ...
   */
  listLbs = (request: Readonly<ZonedApiListLbsRequest> = {}) => enrichForPagination('lbs', this.pageOfListLbs, request)
   ...
   * @returns A Promise of Lb
   */
  waitForLb = (request: Readonly<ZonedApiGetLbRequest>, options?: Readonly<WaitForOptions<Lb>>) =>
    waitForResource(
   ...
   */
  listIPs = (request: Readonly<ZonedApiListIPsRequest> = {}) => enrichForPagination('ips', this.pageOfListIPs, request)
   ...
   */
  listAcls = (request: Readonly<ZonedApiListAclsRequest>) => enrichForPagination('acls', this.pageOfListAcls, request)
...
export class API extends ParentAPI {
   ...
   * @returns A Promise of ListLbsResponse
   */
  listLbs = (request: Readonly<ListLbsRequest> = {}) => enrichForPagination('lbs', this.pageOfListLbs, request)
   ...
   * @returns A Promise of Lb
   */
  waitForLb = (request: Readonly<GetLbRequest>, options?: Readonly<WaitForOptions<Lb>>) =>
    waitForResource(
      options?.stop ?? (res => Promise.resolve(!LB_TRANSIENT_STATUSES_LB.includes(res.status))),
      this.getLb,
      request,
   ...
   * @returns A Promise of ListAclResponse
   */
  listAcls = (request: Readonly<ListAclsRequest>) => enrichForPagination('acls', this.pageOfListAcls, request)
   ...
   * @returns A Promise of Certificate
   */
  waitForCertificate = (request: Readonly<GetCertificateRequest>, options?: Readonly<WaitForOptions<Certificate>>) =>
    waitForResource(
      options?.stop ?? (res => Promise.resolve(!CERTIFICATE_TRANSIENT_STATUSES_LB.includes(res.status))),
      this.getCertificate,
      request,
