...
export type ContactEmailStatus = 'email_status_unknown' | 'validated' | 'not_validated' | 'invalid_email'
...
export type ContactLegalForm = 'legal_form_unknown' | 'individual' | 'corporate' | 'association' | 'other'

export type ContactStatus = 'status_unknown' | 'active' | 'pending'

export type DNSZoneStatus = 'unknown' | 'active' | 'pending' | 'error' | 'locked'
...
export type RenewableDomainStatus = 'unknown' | 'renewable' | 'late_reneweable' | 'not_renewable'

export type SSLCertificateStatus = 'unknown' | 'new' | 'pending' | 'success' | 'error'

export type TaskStatus = 'unavailable' | 'new' | 'waiting_payment' | 'pending' | 'success' | 'error'
