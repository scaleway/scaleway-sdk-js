...
export const CLUSTER_TRANSIENT_STATUSES: ClusterStatus[] = ['creating', 'deleting', 'updating']
...
export const POOL_TRANSIENT_STATUSES: PoolStatus[] = ['deleting', 'scaling', 'upgrading']
