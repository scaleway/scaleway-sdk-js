...
export const SECURITY_GROUP_TRANSIENT_STATUSES: SecurityGroupState[] = ['syncing']

/** Lists transient statutes of the enum {@link ServerFilesystemState}. */
export const SERVER_FILESYSTEM_TRANSIENT_STATUSES: ServerFilesystemState[] = ['attaching', 'detaching']
...
export const SNAPSHOT_TRANSIENT_STATUSES: SnapshotState[] = ['snapshotting', 'importing', 'exporting']

/** Lists transient statutes of the enum {@link TaskStatus}. */
export const TASK_TRANSIENT_STATUSES: TaskStatus[] = ['pending', 'started', 'retry']
