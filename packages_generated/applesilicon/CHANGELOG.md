...
- feat(apple-silicon): add support for `kextEnabled` (#2992)
...
- feat(apple_silicon): add CI-CD runner configuration update API (#2585)

- chore(release): publish

- fix(bundled): remove bundled as it's buggy with deps inside pack with… (#2096)

- feat(applesilicon): remove support for `runner_configuration` (#2457)

- feat(apple_silicon): add batch create endpoints (#2204)
...
- feat(apple_silicon): add CI-CD runner installation APIs (#2440)
...
- feat(apple_silicon): enable bulk order in public sdk (#2234)

- feat(apple_silicon): fix typo in applesilicon SDK comment (#2238)
...
- feat: update generated APIs (#3373)
...
- feat(apple_silicon): enabled kext (#2699)
...
## [2.8.2](https://github.com/scaleway/scaleway-sdk-js/compare/@scaleway/sdk-applesilicon@2.8.1...@scaleway/sdk-applesilicon@2.8.2) (2026-06-29)
...
# [2.7.0](https://github.com/scaleway/scaleway-sdk-js/compare/@scaleway/sdk-applesilicon@2.6.0...@scaleway/sdk-applesilicon@2.7.0) (2026-04-17)
...
# [2.5.0](https://github.com/scaleway/scaleway-sdk-js/compare/@scaleway/sdk-applesilicon@2.4.2...@scaleway/sdk-applesilicon@2.5.0) (2026-04-02)
...
## [2.4.1](https://github.com/scaleway/scaleway-sdk-js/compare/@scaleway/sdk-applesilicon@2.4.0...@scaleway/sdk-applesilicon@2.4.1) (2026-03-05)
