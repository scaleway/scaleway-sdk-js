  ...
  services: [
    {
      ...
      methods: [
        ...
        {
          methodName: 'listDeploymentACLRules',
          protoName: 'ListDeploymentACLRules',
          paramsType: 'ListDeploymentACLRulesRequest',
          returnType: 'ListDeploymentACLRulesResponse',
          isList: true,
          paginationType: 'offset',
          pageParamKey: 'page',
        ...
        {
          methodName: 'getModelEula',
          protoName: 'GetModelEula',
          paramsType: 'GetModelEulaRequest',
          returnType: 'Eula',
          isList: false,
          paginationType: 'none',
          isPrivate: false,
