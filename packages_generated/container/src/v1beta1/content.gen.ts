...
export const DOMAIN_TRANSIENT_STATUSES: DomainStatus[] = ['deleting', 'creating', 'pending', 'locking', 'upgrading']
...
export const TRIGGER_TRANSIENT_STATUSES: TriggerStatus[] = ['deleting', 'creating', 'pending', 'locking', 'upgrading']
