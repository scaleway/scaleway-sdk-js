...
export interface SecretVersion {
   ...
   * version expires.
   */
  ephemeralStatus?: EphemeralStatus
}
...
export interface Secret {
   ...
   */
  ephemeralPolicyTemplate?: EphemeralPolicy
...
export type UpdateSecretVersionRequest = {
  ...
  description?: string
  /**
   * (Optional.) Status that defines the version's expiration date, whether it
   * expires after being accessed once, and the action to perform (disable or
