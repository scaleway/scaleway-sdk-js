...
import { DeniedAuthenticationError } from '../denied-authentication-error'
import { InvalidArgumentsError } from '../invalid-arguments-error'
import { OutOfStockError } from '../out-of-stock-error'
import { PermissionsDeniedError } from '../permissions-denied-error'
import { PreconditionFailedError } from '../precondition-failed-error'
import { QuotasExceededError } from '../quotas-exceeded-error'
import { ResourceExpiredError } from '../resource-expired-error'
import { ResourceLockedError } from '../resource-locked-error'
import { ResourceNotFoundError } from '../resource-not-found-error'
import { TooManyRequestsError } from '../too-many-requests-error'
import { TransientStateError } from '../transient-state-error'
