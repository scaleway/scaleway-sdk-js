...
describe(`responseParser`, () => {
  ...
  // oxlint-disable-next-line typescript/no-unnecessary-type-parameters, typescript/no-unsafe-type-assertion -- test passthrough unwrapper; T is caller-controlled
  ...
  it(`triggers an error for unsuccessful unmarshalling`, async () => {
    ...
    await expect(
      responseParser(() => {
        // oxlint-disable-next-line eslint/no-throw-literal, typescript/only-throw-error -- intentionally throwing a non-error to test error handling
